const imageViewer = (function () {
  ...
  const style = () => {
    return `* {
      ...
      .__crx__image-viewer .__crx__image-viewer-control:hover .__crx__image-viewer-relate .__crx__image-viewer-relate-counter{
        opacity: 1;
      }
      .__crx__image-viewer .__crx__image-viewer-control:hover .__crx__image-viewer-relate .__crx__image-viewer-relate-counter,
      .__crx__image-viewer .__crx__image-viewer-control:hover .__crx__image-viewer-relate .__crx__image-viewer-relate-counter span{
        color: #ddd;
      }
