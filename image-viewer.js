window.ImageViewer = (function () {
  ...
  function addFrameEvent(options) {
    ...
    function initHotkeyMapping(options) {
      ...
      registerHotkey(COMMAND_ENUM.DISABLE_DRAG, options.viewerHotkey.toggleNativeDrag)
  ...
  function addImageEvent(options) {
    ...
    function addTransformHandler(node, getTarget) {
      ...
      node.addEventListener(
        ...
        e => {
          ...
          if (isZoom) {
            ...
            if (options.webtoonMode) updateWebtoonRotate(node, target, context.rotateCount)
